...
//     if (task.project) {
//       userIdsWithTitles.add(task.date); //task.userId
//     }
//   });
...
//         if (task.project === title && !uniqueUserIds.has(task.date)) { //task.userId
//           uniqueUserIds.add(task.date); //task.userId
//           return true;
//         }
//         return false;
//       }).map(task => ({
...
//   navigate('/manager/employee/dashboard', { state: { userId: userId } });
//   }else if(userRole === 'ROLE_HR'){
//     navigate('/hr/manager/employee/dashboard', { state: { userId: userId } });
//   } else {
...
//                 handleRowClick(record.email); //record.userId
//               },
//             };
//           }}
//         />
